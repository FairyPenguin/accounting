...
export interface CatToolFormProps {
    values?: CatToolPayload;
    register: UseFormRegister<CatToolPayload>;
...
export const CatToolForm: React.FC<CatToolFormProps> = ({
    values,
    register,
    handleSubmit,
    errors,
