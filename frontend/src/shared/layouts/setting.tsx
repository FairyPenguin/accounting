...
import IconSettings from "@/shared/components/icon/icon-settings";
import IconX from "@/shared/components/icon/icon-x";
import IconSun from "@/shared/components/icon/icon-sun";
import IconMoon from "@/shared/components/icon/icon-moon";
import IconLaptop from "@/shared/components/icon/icon-laptop";
                    ...
                    <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
                        ...
                        <div className="mt-3 grid grid-cols-3 gap-2">
                            <button
                                type="button"
                                className={`${
                                    themeConfig.theme === "light" ? "btn-primary" : "btn-outline-primary"
                                } btn`}
                            ...
                            <button
                                type="button"
                                className={`${
                                    themeConfig.theme === "dark" ? "btn-primary" : "btn-outline-primary"
                                } btn`}
                            ...
                            <button
                                type="button"
                                className={`${
                                    themeConfig.theme === "system" ? "btn-primary" : "btn-outline-primary"
                                } btn`}
                    ...
                    <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
                        ...
                        <div className="mt-3 grid grid-cols-3 gap-2">
                            <button
                                type="button"
                                className={`${
                                    themeConfig.menu === "horizontal" ? "btn-primary" : "btn-outline-primary"
                                } btn`}
                                onClick={() => {
                            ...
                            <button
                                type="button"
                                className={`${
                                    themeConfig.menu === "vertical" ? "btn-primary" : "btn-outline-primary"
                                } btn`}
                                onClick={() => {
                            ...
                            <button
                                type="button"
                                className={`${
                                    themeConfig.menu === "collapsible-vertical" ? "btn-primary" : "btn-outline-primary"
                                } btn`}
                                onClick={() => {
                    ...
                    <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
                        ...
                        <div className="mt-3 flex gap-2">
                            ...
                            <button
                                type="button"
                                className={`${
                                    themeConfig.layout === "full" ? "btn-primary" : "btn-outline-primary"
                                } btn flex-auto`}
                    ...
                    <div className="mb-3 rounded-md border border-dashed border-white-light p-3 dark:border-[#1b2e4b]">
                        ...
                        <div className="mt-3 flex gap-2">
                            <button
                                type="button"
                                className={`${
                                    themeConfig.rtlClass === "ltr" ? "btn-primary" : "btn-outline-primary"
                                } btn flex-auto`}
                            ...
                            <button
                                type="button"
                                className={`${
                                    themeConfig.rtlClass === "rtl" ? "btn-primary" : "btn-outline-primary"
                                } btn flex-auto`}
